...
VALUES
	...
	('madison_montgomery', 'KGyWa-yC-5wM3U@@e7us', 3),
...
VALUES
	...
	(10, 'Elle', 'Driver', 'elle.driver@example.com', '+200420044', '1970-04-13');
...
VALUES
	('2023-10-24 12:00:00', 1, 1),
	('2023-10-24 12:15:00', 2, 1),
	('2023-10-24 12:30:00', 3, 1),
	('2023-10-24 12:45:00', 4, 1),
	('2023-10-24 13:00:00', 5, 1),
	...
	('2023-10-25 08:30:00', 3, 2),
	('2023-10-25 08:45:00', 4, 2),
	('2023-10-25 09:00:00', 5, 2),
	('2023-10-25 09:15:00', 6, 2),
...
INSERT INTO country (name, capital, state_system_id)
VALUES
	('France', 'Paris', 2),
	('The Grand Duchy of Lithuania', 'Vilnius', 1),
	('Empire of Japan', 'Tokyo', 1),
	('The Russian Empire', 'Saint Petersburg', 1),
	('The Kingdom of the Netherlands', 'Amsterdam', 1),
	('Tokugawa shogunate', 'Edo', 1),
	('The United States of America', 'Washington', 2);

INSERT INTO historical_figure (first_name, last_name, birth_date, death_date)
VALUES
	('Marie', 'Curie', '1867-11-07', '1934-07-04'),
	('Vytautas', 'Keystutovich', '1350-01-01', '1430-10-27'),
	('Hirohito', NULL, '1901-04-29', '1989-01-07'),
	('Jogaila', NULL, '1352-01-01', '1434-06-01'),
	('Alexander', 'Blok', '1880-11-28', '1921-08-07'),
	('Anna', 'Akhmatova', '1889-06-23', '1966-03-05'),
	('Sergei', 'Yesenin', '1895-10-03', '1925-12-28'),
	('Claude', 'Monet', '1840-11-14', '1926-12-05'),
	('Vincent', 'van Gogh', '1853-03-30', '1890-07-29'),
	('Ieyasu', 'Tokugawa', '1543-01-31', '1616-06-01'),
	('Marie', 'Antoinette', '1755-11-02', '1793-10-16'),
	('Sigismund', 'Vasa', '1566-06-20', '1632-04-30'),
	('Thomas', 'Jefferson', '1743-04-13', '1826-07-04');
	
INSERT INTO figure_country_doc_linc (historical_figure_id, country_id, document_id)
VALUES
	(1, 1, 1),
	(2, 2, 2),
	(3, 3, 3),
...
VALUES
	('History of The Grand Duchy of Lithuania', 'Documents covering key moments in the history of the GDL.'),
    ('History of Japan', 'Collection of documents narrating the history of Japan.'),
    ('Women in History', 'Documents dedicated to prominent women in history.'),
    ('Literature and Art', 'Collection of documents about art and literature.'),
    ('History of France', 'Documents covering key moments in the history of France.'),
    ('Essential Documents in History', 'Compilation of important historical documents.');
